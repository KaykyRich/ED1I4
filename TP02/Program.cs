    ...
    internal class Program
    {
        static void Main(string[] args)
        {
			...
			do
			{
				...
				Console.WriteLine("2 - Pesquisar curso (Mostrar as disciplinas associadas)");
				...
				Console.WriteLine("5 - Pesquisar disciplina (Mostrar os alunos matriculados)");
				Console.WriteLine("6 - Remover disciplina do curso (Obs. Não pode ter nenhum aluno matriculado)");
